      ...
      <div className="flex justify-between items-center py-6">
        <div>
          ...
          <div className="flex items-center gap-4 mt-4">
            <Link href="https://github.com/muditsharma01"><BsGithub className="text-lg text-gray-200 hover:text-textDesignColor h-10 cursor-pointer" /></Link>
            <BsFacebook className="text-lg text-gray-200 hover:text-textDesignColor cursor-pointer" />
            <Link href="https://nextjs.org/"><TbBrandNextjs className="text-lg text-gray-200 hover:text-textDesignColor cursor-pointer" /></Link>
            <Link href="https://twitter.com/nextjs?s=20"><AiFillTwitterCircle className="text-lg text-gray-200 hover:text-textDesignColor cursor-pointer" /></Link>
